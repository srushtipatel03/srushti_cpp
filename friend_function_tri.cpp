//frienf function - friend operator overloading
...
class Triangle
{
  ...
  int main()
  {
    ...
    cout << "triangle 1 is:" << triangle1.getdata() << endl;

    triangle2.setdata(3,7);
    cout << "triangle 2 is:" << triangle2.getdata() << endl;

    triangle3 =  triangle1 + triangle2;
    cout << "triangle 3 is:" << triangle3.getdata() << endl;
  }